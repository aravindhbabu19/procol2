    ...
    <div class='footer-footer text-dark p-4 mt-4'>
        <div class='row footer-row'>
          ...
          <div class='col-12 col-sm-12 col-md-4 col-lg-4 footer-col mt-3'>
            <h4 class='footer-h4  ms-3'>Mounika Paramedical College</h4>
            <hr class='footer-hr  ms-3' />
            <p class='footer-p  ms-3'>100 ft road, Nandikotkur Rd,<br></br> opp. Omega hospital,<br></br> Kurnool, Andhra Pradesh 518004</p>
            <h4 class=' ms-3'>Mob :</h4>
            <p class='footer-p  ms-3'>+91 9441881799, 8317680122</p>
            <h4 class=' ms-3'>Email :</h4>
            <p class='footer-p  ms-3'>mounikaparamedicalcollege@gmail.com</p>
            <p class='footer-p  ms-3'>info@mounikaparamedicalcollege.org</p>
          </div>
          <div class='col-12 col-sm-12 col-md-4 col-lg-4 footer-col mt-3'>
